...
export async function fetchInboundSummary(storeId: string = 'DS-Brooklyn-04', date?: string): Promise<InboundSummary> {
  const dateParam = date || new Date().toISOString().split('T')[0];
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/summary?storeId=${storeId}&date=${dateParam}`);
...
export async function fetchGRNList(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/grn?${params}`);
...
export async function fetchGRNDetails(grnId: string): Promise<GRNDetailsResponse> {
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/grn/${grnId}`);
...
export async function startGRNProcessing(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/grn/${grnId}/start`, {
    method: 'POST',
    headers: {
...
export async function updateGRNItemQuantity(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/grn/${grnId}/items/${sku}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function completeGRNProcessing(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/grn/${grnId}/complete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function fetchPutawayTasks(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/putaway?${params}`);
...
export async function assignPutawayTask(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/putaway/${taskId}/assign`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function completePutawayTask(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/putaway/${taskId}/complete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function fetchInterStoreTransfers(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/transfers?${params}`);
...
export async function receiveInterStoreTransfer(
  ...
  const response = await fetch(`${API_BASE_URL}/api/darkstore/inbound/transfers/${transferId}/receive`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
